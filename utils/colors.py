...
{Colors.RED}{Colors.BOLD}
  ...
  ██║  ██║███████╗╚██████╗╚██████╔╝██║ ╚████║   ██║   ╚██████╔╝╚██████╔╝███████╗
  ╚═╝  ╚═╝╚══════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝   ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝
{Colors.RESET}{Colors.DARK_GRAY}  Offensive Recon Framework  {Colors.WHITE}v3.2.0{Colors.DARK_GRAY}  |  Python + Bash  |  {Colors.RED}For Authorized Testing Only{Colors.RESET}
"""
    print(art)
