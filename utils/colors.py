...
def banner(version: str = "3.2.4"):
    """Print the clean ORFX startup identity."""
    lines = [
    ...
    print(f"  {Colors.BOLD}{Colors.WHITE}OFFENSIVE RECON FRAMEWORK{Colors.RESET}  {Colors.DARK_GRAY}v{version}{Colors.RESET}")
    print(f"  {Colors.DARK_GRAY}{'─' * 58}{Colors.RESET}")
